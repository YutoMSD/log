...
**2026/09/22** 学部の時の論文と同じ主張の論文がNcomに出ててびっくり。こちらはNphys->Nmat->Neleとたらい回し。新規性とは何だろうか。~~Nature系列の仕事は遅い。~~今後とも仲良くしてください。

**2026/09/21** クリーンルームからの一週間の垢バン。反省はしている。

**2026/09/19** 共用設備であるクリーンルームの装置を使うにはqualifiation sessionを受け、承認される必要がある。ポスドクのアカウントを使って勝手に装置を使っていることがばれた。大問題である。
